...
export function ExecutionCard({ execution }: { execution: AdminExecution }) {
    ...
    <Card>
      <CardContent className="p-4">
        ...
        <div className="text-xs text-muted-foreground mb-3">
          {s.application_name} · {formatDate(s.submitted_at || s.started_at)}
        </div>
        ...
        {rejectOpen && (
          <Modal title={t('admin.executions.rejectReason')} onClose={() => setRejectOpen(false)}>
